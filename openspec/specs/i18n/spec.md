...
## Purpose
Cross-cutting frontend internationalization: supported locales, translation-backed UI copy, header language switching, locale persistence, and locale-aware formatting.
